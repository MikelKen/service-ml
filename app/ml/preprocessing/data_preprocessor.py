...
class DataPreprocessor:
    ...
    def __init__(self):
        ...
        self.tfidf_skills = TfidfVectorizer(max_features=100, ngram_range=(1, 2), stop_words=['y', 'e', 'o', 'de', 'la', 'el'])
        self.tfidf_requirements = TfidfVectorizer(max_features=100, ngram_range=(1, 2), stop_words=['y', 'e', 'o', 'de', 'la', 'el'])
    ...
    def preprocess_mongodb_data(self, df: pd.DataFrame, fit_transformers: bool = True) -> pd.DataFrame:
